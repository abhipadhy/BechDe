...
<html lang="en">
  ...
  <body>
    ...
    if(mysqli_num_rows($result)!=0){
     ...
     mysqli_close($conn);
    ?>
    <a href="editprof.php" style="text-decoration: none;text-transform:capitalize"><button id="edit">edit profile</button></a><br><br>
       
        <span  id="purchased" style="cursor:pointer;text-transform: capitalize;" ><button style="color:#26133f;">Purchased Products</button> </span>
           ...
           <div class="pc">
            <div class="card">
              ...
              <div class="right1">
                  ...
                  <p id="desc">"Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quos maiores aut eveniet fuga necessitatibus cupiditate, eligendi consequuntur sit. Quam est at perspiciatis voluptates voluptatum, doloremque fugiat quis soluta non sunt!"</p>
                  <table>
                      <tr><td id="buy" style="font-weight: 500;">$ 100</td>
                      <td id="rent" style="font-weight: 500;">$10</td></tr>
